<template>
	<footer class="bg-black text-white">
        <div class="xl:max-w-screen-lg mx-auto divide-y bg-black dark:text-white">
		<div class="container flex flex-col justify-between py-10 mx-auto space-y-8 lg:flex-row lg:space-y-0">
			<div class="lg:w-1/3">
                ...
                <p class="mx-8 text-sm text-gray-400">
                    agence de marketing spécialisé dans le domaine digitale pour accompagner les photographe, les vidéastes à augmenter leur visibilité
                </p>
			</div>
		...
		<div class="py-6 text-sm text-center dark:text-gray-600">© 2025 Zikagen Agency. Tout droit réserver.</div>
    </div>
	</footer>
</template>
<script setup>
